---
name: create-prd-tasks
description: "Convert PRDs to ralph-prd.json format for the Ralph autonomous agent system. Use when you have an existing PRD and need to convert it to Ralph's JSON format. Triggers on: convert this prd, turn this into ralph format, create ralph-prd.json from this, ralph json."
---
